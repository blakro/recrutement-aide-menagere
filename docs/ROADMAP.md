...
- **Fiche de consignes** générée à partir des lacunes repérées (hygiène, sécurité), à remettre à la candidate embauchée.
- **Audio** : questions enregistrées en zarma et haoussa par un locuteur natif (exception à la règle du fichier unique, à décider).
- **PWA installable hors ligne** (manifest + service worker : exception à la règle du fichier unique, à décider).
- **Comparateur** de 2 ou 3 candidates côte à côte.
